...
! diagnostic
!write(*,*) 'diagnostics of basis function calculations:'
!write(*,*) 'integral of v0 basis functions'
!do i=1,nv0
!  write(*,'(i4,f8.4)') i,gaussian_quadrature%integrate(v0_basis(i,:,:,:,1))
!end do
!write(*,*) 'integral of grad(v0) basis functions'
!do i=1,nv0
!  write(*,'(i4,3f8.4)') i,gaussian_quadrature%integrate(grad_v0_basis(i,:,:,:,1)), &
!                          gaussian_quadrature%integrate(grad_v0_basis(i,:,:,:,2)), &
!                          gaussian_quadrature%integrate(grad_v0_basis(i,:,:,:,3))
!end do
!write(*,*) 'integral of v1 basis functions'
!do i=1,nv1
!  write(*,'(i4,3f8.4)') i,gaussian_quadrature%integrate(v1_basis(i,:,:,:,1)), &
!                          gaussian_quadrature%integrate(v1_basis(i,:,:,:,2)), &
!                          gaussian_quadrature%integrate(v1_basis(i,:,:,:,3))
!end do
!write(*,*) 'integral of curl(v1) basis functions'
!do i=1,nv1
!  write(*,'(i4,3f8.4)') i,gaussian_quadrature%integrate(curl_v1_basis(i,:,:,:,1)), &
!                          gaussian_quadrature%integrate(curl_v1_basis(i,:,:,:,2)), &
!                          gaussian_quadrature%integrate(curl_v1_basis(i,:,:,:,3))
!end do
!write(*,*) 'integral of v2 basis functions'
!do i=1,nv2
!  write(*,'(i4,3f8.4)') i,gaussian_quadrature%integrate(v2_basis(i,:,:,:,1)), &
!                          gaussian_quadrature%integrate(v2_basis(i,:,:,:,2)), &
!                          gaussian_quadrature%integrate(v2_basis(i,:,:,:,3))
!end do
!write(*,*) 'integral of div(v2) basis functions'
!do i=1,nv2
!  write(*,'(i4,f8.4)') i,gaussian_quadrature%integrate(div_v2_basis(i,:,:,:,1))
!end do
!write(*,*) 'integral of v3 basis functions'
!do i=1,nv3
!  write(*,'(i4,f8.4)') i,gaussian_quadrature%integrate(v3_basis(i,:,:,:,1))
!end do
