...
!-------------------------------------------------------------------------------
!-------------------------------------------------------------------------------
! Computes the global and local number of dofs for the 4 element spaces 
! V0..V3
!-------------------------------------------------------------------------------
module num_dof_mod
...
!-----------------------------------------------------------------------------
! Subroutine to compute the local and global number of dofs 
!-----------------------------------------------------------------------------
implicit none
...
! diagnostic output
write(*,*) 'ncells = ',ncells,'nlayers = ',nlayers
write(*,'(a)')     '   space     |   V0   |   V1   |   V2   |   V3   |'
write(*,'(a,i6,a,i6,a,i6,a,i6)') 'global dof    ',nv0_g,'   ',nv1_g,'   ',nv2_g,'   ',nv3_g
write(*,'(a,i6,a,i6,a,i6,a,i6)') 'local dof     ',nv0,'   ',nv1,'   ',nv2,'   ',nv3
write(*,'(a,i6,a,i6,a,i6,a,i6)') 'dof in volume ',nv0_cell,'   ',nv1_cell,'   ',nv2_cell,'   ',nv3
write(*,'(a,i6,a,i6,a,i6,a,i6)') 'dof on face   ',nv0_face,'   ',nv1_face,'   ',nv2_face,'   ',0
write(*,'(a,i6,a,i6,a,i6,a,i6)') 'dof on edge   ',nv0_edge,'   ',nv1_edge,'   ',0,'   ',0
write(*,'(a,i6,a,i6,a,i6,a,i6)') 'dof on vert   ',nv0_vert,'   ',0,'   ',0,'   ',0
